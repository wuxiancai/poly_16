...
sudo usermod -a -G lightdm wuxiancai
sudo usermod -a -G nopasswdlogin wuxiancai
...
# 3. 配置 TigerVNC Server for wuxiancai user
echo "为用户 ${USERNAME} 配置 TigerVNC..."
# 切换到 wuxiancai 用户执行 vncpasswd，然后切回
...
User=wuxiancai
Group=wuxiancai
WorkingDirectory=/home/wuxiancai
Environment=HOME=/home/wuxiancai
Environment=USER=wuxiancai
...
AUTOSTART_FILE="/home/wuxiancai/.config/lxsession/LXDE/autostart"
